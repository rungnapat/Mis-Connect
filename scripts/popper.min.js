...
!function (e, t) {
    ...
    function B(e, n) {
        ...
        var i = o.boundary,
            a = void 0 === i
                ? "clippingParents"
                : i,
            s = void 0 === (i = o.rootBoundary)
                ? "viewport"
                : i;
        i = void 0 === (i = o.elementContext)
            ? "popper"
            : i;
        var p = o.altBoundary,
            c = void 0 !== p && p;
    ...
    function R(e) {
        ...
        if (u) {
            var w = b(o),
                ...
                O = "clientWidth";
            w === n(o) && (
                "static" !== c(w = f(o)).position && "absolute" === p && (x = "scrollHeight", O = "scrollWidth")
            ),
        ...
        l
            ? Object.assign({}, o, (
                ...
                h[v] = m
                    ? "0"
                    : "",
                h.transform = 1 >= (y.devicePixelRatio || 1)
                    ? "translate(" + e + "px, " + d + "px)"
    ...
    var N = [
        ...
        _ = (
            "beforeRead read afterRead beforeMain main afterMain beforeWrite write afterWri" +
            "te"
        ).split(" "),
        U = Math.max,
        z = Math.min,
        ...
        Q = {
            ...
            fn: function (e) {
                ...
                null != t.modifiersData.popperOffsets && (
                    t.styles.popper = Object.assign({}, t.styles.popper, R(Object.assign({}, e, {
                ...
                null != t.modifiersData.arrow && (
                    t.styles.arrow = Object.assign({}, t.styles.arrow, R(Object.assign({}, e, {
        ...
        $ = {
            ...
            fn: function (e) {
                var t = e.state,
                    n = e.name,
                    o = void 0 === (e = e.options.offset)
                        ? [0, 0]
                        : e,
                    r = (e = I.reduce((function (e, n) {
                        var r = t.rects,
                            i = x(n),
                            a = 0 <= ["left", "top"].indexOf(i)
                                ? -1
                                : 1,
                            s = "function" == typeof o
